...
<head>
  ...
  {/* <script src="https://kit.fontawesome.com/36f3a0ef1b.js" crossorigin="anonymous"></script> */}
          ...
          <div class="event-block">
            <div class="row">
              ...
              <div class="col-lg-5 sec-3">
                <div class="title">Event Name Here</div>
                <div class="venue">
                  <table>
                    <tr>
                ...
                <div class="time">
                  <table>
                    <tr>
                      ...
                      <td>
                        <div>Saturday, Aug 27, 2023 at 5:30 PM</div>
                        <div class="dim-color"></div>
                      </td>
                    </tr>
                  </table>
                </div>
                <div class="Description">  Event Description Here  </div>
                <div class="group-of-btn">
                  <a href="" target="blank" class="btn book-ticket">Book Your Entry Pass</a>
                </div>
              </div>
            </div>
          </div>
            ...
            >
              ...
              <div className="col-span-2 lg:col-span-3 lg:flex lg:items-end">
                <form className="w-full">
                  ...
                  <div
                    className=" p-2 focus-within:ring border-gray-800 sm:flex sm:items-center sm:gap-4"
                  >
                    <input
                      type="email"
                      id="UserEmail"
              ...
              <div className="col-span-2 sm:col-span-1">
                ...
                <ul className="mt-6 space-y-4 text-sm">
                  <li>
                    <a
                      href="#"
                      className="text-gray-700 transition hover:opacity-75 dark:text-gray-200 no-underline"
                    >
                      1on1 Coaching
                    </a>
                  </li>
              ...
              <div className="col-span-2 sm:col-span-1">
                <p className="font-medium text-gray-900 dark:text-white no-underline">Helpful Links</p>
